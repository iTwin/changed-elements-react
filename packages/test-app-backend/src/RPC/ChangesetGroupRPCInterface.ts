...
import { RpcInterface, RpcManager, IModelRpcProps } from "@itwin/core-common";
...
export abstract class ChangesetGroupRPCInterface extends RpcInterface {
  ...
  public async getChangesetGroup(_iModelToken: IModelRpcProps): Promise<unknown> { return this.forward(arguments); } // this does something cool
}
