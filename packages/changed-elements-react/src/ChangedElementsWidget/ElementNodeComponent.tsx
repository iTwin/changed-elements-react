...
import { SvgChevronRight, SvgCompare } from "@itwin/itwinui-icons-react";
import { Checkbox, IconButton } from "@itwin/itwinui-react";
import { Component, ReactElement } from "react";
import { ChangedElementEntry } from "./ChangedElementEntryCache";
import { getTypeOfChangeTooltip } from "./ChangesTooltipProvider";
...
export class ElementNodeComponent extends Component<ElementListNodeProps> {
  ...
  public override render(): ReactElement {
    ...
    const tooltip = label + " (" + this._getChangeType(this.props.opcode)
    ...
    return (
      <div key={this.props.id} className={nodeClasses} onClick={this.props.onClick}>
        <div className="checkbox-container">
          <Checkbox variant="eyeball" checked={this.props.visible} onClick={this.props.toggleVisibility} />
        </div>
        {
          this.props.wantChangeSquare &&
          <div className={this._getChangeSquareClass()} title={this._getChangeSquareTooltip()} />
        }
        <div className={`type-icon icon ${this.props.isModel ? "icon-folder" : "icon-item"}`} />
        ...
        <IconButton
          ...
          className={`vc-element-inspect-button ${(this.props.selected && !this.props.isModel
            && this.props.opcode !== undefined && VersionCompare.manager?.wantNinezone
